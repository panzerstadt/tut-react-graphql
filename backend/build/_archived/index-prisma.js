...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    var newLink, viewLinks;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma.createLink({
                    description: "something that i just placed onto aws!",
                    url: "www.google.com"
                })];
            case 1:
                newLink = _a.sent();
                console.log(("just created a new link " + newLink.id + " at " + newLink.createdAt + " about \"" + newLink.description + "\"")
                    .bgCyan);
                return [4 /*yield*/, prisma.links()];
            case 2:
                viewLinks = _a.sent();
